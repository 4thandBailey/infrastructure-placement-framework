...
|---|---|---|---|
| Cost gravity | 25% | **25%** | Unchanged — cost optimisation is important at scale |
...
| Private AI infrastructure fit | 15% | **15%** | Unchanged — AI for route optimisation and predictive logistics is growing |

---

## Edge computing consideration

Logistics organisations are among the most common candidates for edge computing deployment. Workloads to evaluate for edge placement:
...
| Route optimisation (AI) | Near-real-time response for driver updates | Edge or private cloud |
...
| TSA cybersecurity directives | Surface transportation (pipelines, rail, aviation) | Mandatory reporting and security programme requirements |
